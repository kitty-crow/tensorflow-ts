...
describeMathCPUAndGPU('LayersModel.fitDataset', () => {
  ...
  it('1 input, 2 outputs, 1 metric, tensor array validation, ' +
     ...
     async () => {
       ...
       expect(history.history[output2AccName][1]).toBeCloseTo(0);
       expect(history.history.val_loss.length).toEqual(2);
       expect(history.history.val_loss[0]).toBeCloseTo(0.006642);
       expect(history.history.val_loss[1]).toBeCloseTo(0.023597);
       expect(history.history[valOutput1LossName].length).toEqual(2);
       expect(history.history[valOutput1LossName][0]).toBeCloseTo(0.003321);
       expect(history.history[valOutput1LossName][1]).toBeCloseTo(0.011798);
       ...
       expect(history.history[valOutput1AccName][0]).toBeCloseTo(1);
       expect(history.history[valOutput1AccName][1]).toBeCloseTo(1);
